'use strict';
/* build-hook-start *//*00001*/try { require('/Users/murilolodovico/.vscode/extensions/wallabyjs.console-ninja-1.0.532/out/buildHook/index.js').default({tool: 'jest', checkSum: '2053536ac0a2b2f5346eedBwobBBhRWQECVwNRBAFWDVJSUlAB', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/murilolodovico/.vscode/extensions/wallabyjs.console-ninja-1.0.532/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2053536ac0a2b2f5346eedBwobBBhRWQECVwNRBAFWDVJSUlAB', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
